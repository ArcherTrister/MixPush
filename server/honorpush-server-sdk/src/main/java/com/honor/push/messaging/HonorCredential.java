 ...
 */
public class HonorCredential {
    private static final Logger logger = LoggerFactory.getLogger(HonorCredential.class);
    ...
    private HonorCredential(Builder builder) {
    ...
    /**
     * Builder for constructing {@link HonorCredential}.
     */
    ...
    public static class Builder {
        ...
        public HonorCredential build() {
            return new HonorCredential(this);
        }
    }
}

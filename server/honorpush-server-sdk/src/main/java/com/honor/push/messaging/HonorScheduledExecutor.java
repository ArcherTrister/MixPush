 ...
 *  2019.12.15-Changed constructor HonorScheduledExecutor
 ...
 */
public class HonorScheduledExecutor extends ScheduledThreadPoolExecutor {

    public HonorScheduledExecutor(ThreadFactory threadFactory, String name) {
        this(threadFactory, name, null);
    }

    public HonorScheduledExecutor(ThreadFactory threadFactory, String name, Thread.UncaughtExceptionHandler handler) {

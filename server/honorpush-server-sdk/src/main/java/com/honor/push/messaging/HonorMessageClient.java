 ...
 */
public interface HonorMessageClient {
     ...
     */
    SendResponse send(Message message, boolean validateOnly, String accessToken) throws HonorMesssagingException;

    SendResponse send(TopicMessage message, String operation, String accessToken) throws HonorMesssagingException;
}
